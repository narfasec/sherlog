...
from modules.sherlog_redshift import SherlogRedshift
...
def main(format, output):
	...
	try:
		...
		return "Scan was finished successfully"
	except Exception:
		return "Error on sherlog scan"

if __name__ == "__main__":
	main(format='--json', output='octo-output.json')
